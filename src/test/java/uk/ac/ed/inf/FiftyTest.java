...
public class FiftyTest {
    ...
    @Test
    public void testFlightPathWithFiftyOrders() throws IOException, URISyntaxException, InterruptedException {
        // Arrange
        String url = "https://ilp-rest-2024.azurewebsites.net";

        Restaurant[] restaurants = GetHandler.getRestaurants(url);
        Order[] orders = readOrdersFromFile("fiftyOrder.json");
        ...
        assertTrue(flightPath.size() > 100, "Flight path should contain over this many moves ");
        assertTrue(orders.length == 50,"should be 50 orders");
